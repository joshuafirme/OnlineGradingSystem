...
<div class="row page-titles">
    <div class="col-md-6 col-8 align-self-center">
        <h3 class="text-themecolor mb-0 mt-0"><i class="fas fa-user"></i> Report Card</h3>
    </div>
</div>
<?php 
 if (($_GET['url'] == 'myrecords' && !isset($_GET['sy'])) || ($_GET['url'] == 'report_card' && !isset($_GET['sy']))) {
  ?>
<div class="col-md-12">
	<div class="card-header  bg-info">
		<h3 class="text-white"><i class="fas fa-list"></i> Report Card</h3>
	</div>
...
<div class="row" style="padding-bottom: 15px;">
    <div class="col-md-12">
        <a class="btn btn-danger" href="index.php?url=report_card"><i class="fas fa-arrow-left"></i> Back</a>
    </div>
</div>
<div class="col-md-12">
	<div class="card-header  bg-info">
		<h3 class="text-white"><i class="fas fa-list"></i> List of My Report Card</h3>
	</div>
	<div class="card" style="padding-top: 5px;box-shadow: 3px 5px 5px 3px #888888; padding: 3px;">
		<div class="card-body">

		<div class="ml-4">
		Student ID: <input type="text" class="form-control table-input" id="student_id" style="width: 250px;">
		</div>
