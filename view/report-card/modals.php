            ...
            <div class="modal-body">
                ...
                <div class="row" style="padding-bottom: 8px;">
                    <div class="col-md-12" >
                        ...
                        <div id="val_loadyearlevel_edit"></div>
                    </div>
                </div>
                 <div class="row" style="padding-bottom: 8px;">
                    <div class="col-md-12" >
...
<div id="subjectlist" class="modal bs-example-modal-lg " tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;"  data-backdrop="static">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h4 class="modal-title text-white" id="myLargeModalLabel"><i class="fas fa-book"></i> Grade Report</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
            <div class="row col-md-6">
                    ...
                    <div class="col-md-3 float-right">
                     <button id="btn-print-report" class="btn btn-info mt-4 float-right"><i class="fas fa-print"></i> Print</button>
             		</div>
                </div>
